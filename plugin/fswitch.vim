...
augroup fswitch_au_group
    ...
    au BufEnter *.cc   call s:SetVariables('hh,h',              'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|')
    ...
    au BufEnter *.C    call s:SetVariables('H',                 'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|')
    au BufEnter *.cu   call s:SetVariables('cuh,hpp,hxx,hh,h',  'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|')
    au BufEnter *.m    call s:SetVariables('h',                 'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|')
    au BufEnter *.h    call s:SetVariables('c,cc,cpp,cxx,cu,m', 'reg:/include/src/,reg:/include.*/src/,ifrel:|/include/|../src|')
    ...
    au BufEnter *.cuh  call s:SetVariables('cu',                'reg:/include/src/,reg:/include.*/src/,ifrel:|/include/|../src|')
augroup END
